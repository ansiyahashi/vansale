...
public class SalesOrderActivity extends AppCompatActivity implements OncompletCallback {
      int OrderId;
    ...
    public void onclick(Object data) {
         ...
         dialog = QtyPopUpDiaLogue.newInstance(1,selectedProduct.getSrate());
