...
public class Saleshistory extends AppCompatActivity implements OncompletCallback {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // String date = new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault()).format(new Date(Date));
                ...
                List<SalesLineModel> orderModels=orderLines.selectsales(Date);


                RecyclerView recyclerView = (RecyclerView) findViewById(R.id.shrecyclerview);
                SaleshistoryAdapter adapter = new SaleshistoryAdapter(orderModels, Saleshistory.this);
