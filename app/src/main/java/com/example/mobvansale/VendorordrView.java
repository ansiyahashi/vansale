...
public class VendorordrView extends AppCompatActivity implements OncompletCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendorordr_view);
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.VOrecyclerview);
        listofvendororderAdapter adapter = new listofvendororderAdapter(orderModels,this);
