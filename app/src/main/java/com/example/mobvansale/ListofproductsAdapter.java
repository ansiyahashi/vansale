...
public class ListofproductsAdapter extends RecyclerView.Adapter<ListofproductsAdapter.ViewHolder>{
    ...
    public ListofproductsAdapter(List<Productinsertionmodel> listdata,OncompletCallback oncompletCallback) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.listofproducts, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            holder.pprice.setText("Purchaserate");
            holder.catogory.setText("Catogory");
            holder.qty.setText("Qty");
            holder.sprice.setText("Salesrate");

            holder.expdate.setText("Expirydate");
            ...
            holder.pprice.setText(myListData.getPrate());
           holder.catogory.setText(myListData.getCatogry());

            holder.sprice.setText(myListData.getSrate());

            holder.expdate.setText(myListData.getEdate());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        public TextView name,sprice,pprice,catogory,qty,expdate;
        public LinearLayout relativeLayout;
        public ViewHolder(View itemView) {
            super(itemView);
            this.name = (TextView) itemView.findViewById(R.id.productname);
            this.sprice = (TextView) itemView.findViewById(R.id.srate);
           this.catogory=(TextView) itemView.findViewById(R.id.catogory);
            this.qty = (TextView) itemView.findViewById(R.id.qty);

            this.pprice = (TextView) itemView.findViewById(R.id.prate);
            this.expdate = (TextView) itemView.findViewById(R.id.edate);
